...
EduSync serves multiple schools from one application. The same person may belong
...
- Rejected: a client value is not authority. EduSync stores a slug for UX only
