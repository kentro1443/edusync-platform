...
const users = [
  {
    ...
    email: "platform@edusync.local",
    displayName: "Quản trị nền tảng",
  },
  {
    id: "20000000-0000-4000-8000-000000000002",
    email: "admin.minhkhai@edusync.local",
    displayName: "Nguyễn Minh Anh",
  },
  {
    id: "20000000-0000-4000-8000-000000000003",
    email: "teacher.minhkhai@edusync.local",
    displayName: "Trần Thu Hà",
  },
  {
    id: "20000000-0000-4000-8000-000000000004",
    email: "mentor.minhkhai@edusync.local",
    displayName: "Lê Quốc Bảo",
  },
  {
    id: "20000000-0000-4000-8000-000000000005",
    email: "student.minhkhai@edusync.local",
    displayName: "Phạm Gia Huy",
  },
  {
    id: "20000000-0000-4000-8000-000000000006",
    email: "parent.minhkhai@edusync.local",
    displayName: "Phạm Thanh Mai",
  },
  {
    id: "20000000-0000-4000-8000-000000000007",
    email: "club.minhkhai@edusync.local",
    displayName: "Võ Hoàng Nam",
  },
  {
    id: "20000000-0000-4000-8000-000000000008",
    email: "approver.minhkhai@edusync.local",
    displayName: "Đặng Ngọc Lan",
  },
  {
    id: "20000000-0000-4000-8000-000000000009",
    email: "admin.nguyendu@edusync.local",
    displayName: "Bùi Đức Long",
  },
  {
    id: "20000000-0000-4000-8000-000000000010",
    email: "teacher.nguyendu@edusync.local",
    displayName: "Đỗ Mai Phương",
  },
  {
    id: "20000000-0000-4000-8000-000000000011",
    email: "mentor.nguyendu@edusync.local",
    displayName: "Hồ Nhật Minh",
  },
  {
    id: "20000000-0000-4000-8000-000000000012",
    email: "student.nguyendu@edusync.local",
    displayName: "Ngô Bảo Ngọc",
  },
  {
    id: "20000000-0000-4000-8000-000000000013",
    email: "parent.nguyendu@edusync.local",
    displayName: "Ngô Thanh Sơn",
  },
  {
    id: "20000000-0000-4000-8000-000000000014",
    email: "club.nguyendu@edusync.local",
    displayName: "Dương Khánh Linh",
  },
  {
    id: "20000000-0000-4000-8000-000000000015",
    email: "approver.nguyendu@edusync.local",
    displayName: "Tạ Quang Vinh",
  },
  {
    id: "20000000-0000-4000-8000-000000000016",
    email: "admin.multischool@edusync.local",
    displayName: "Nguyễn Hoài An",
  },
  {
    id: "20000000-0000-4000-8000-000000000017",
    email: "dev@edusync.local",
    displayName: "Nhà phát triển EduSync",
...
const demoResources = [
  {
    ...
    body: "Tài nguyên demo của EduSync. Hãy chọn một mục tiêu, chia thành hành động nhỏ và rà soát vào cuối tuần.",
