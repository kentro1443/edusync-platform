...
export const metadata: Metadata = {
  description:
    "EduSync số hóa cố vấn học tập, tài liệu ôn thi, lịch hẹn và quy trình phê duyệt CLB/sự kiện cho các trường THPT — an toàn, minh bạch, có kiểm soát.",
};
...
function ProductPreview() {
  ...
  return (
    <div aria-label="Xem trước không gian vận hành EduSync" className="marketing-float relative mx-auto max-w-[36rem] lg:mx-0">
        ...
        <Container className="relative grid items-center gap-14 py-16 lg:grid-cols-[1fr_0.92fr] lg:py-24">
          <Reveal className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[var(--color-brand-100)]">
              EduSync hợp nhất cố vấn, học liệu, lịch hẹn và quy trình hành chính;
        ...
        <Container>
          <div className="flex flex-col items-center gap-6 rounded-[var(--radius-xl)] bg-[var(--color-brand-700)] px-8 py-14 text-center text-white sm:px-16">
            ...
            <p className="max-w-xl text-[var(--color-brand-100)]">
              ...
              EduSync phù hợp với quy trình vận hành hiện tại của trường.
            </p>
