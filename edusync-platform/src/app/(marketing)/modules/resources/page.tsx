...
const content: ModulePageContent = {
  ...
  heroDescription:
    "Chấm dứt tình trạng đề thi trôi nổi trong các nhóm chat. EduSync tổ chức toàn bộ tài liệu ôn tập theo môn học, khối lớp và năm học, với quy trình kiểm duyệt rõ ràng trước khi công bố.",
