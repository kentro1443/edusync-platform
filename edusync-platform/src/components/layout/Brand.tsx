  ...
  return (
    ...
    >
      <span className="relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-[0.8rem] bg-[var(--color-brand-800)] shadow-[var(--shadow-sm)] ring-1 ring-white/15">
        ...
        <span aria-hidden="true" className="relative text-sm font-extrabold tracking-[-0.08em] text-white">ES</span>
      </span>
      {!compact ? (
        <span>
          <span className="block text-[1.05rem] font-extrabold leading-none tracking-[-0.035em]">EduSync</span>
