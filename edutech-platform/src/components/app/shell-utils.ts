...
const auditActionLabels: Record<string, string> = {
  ...
  DEV_IMPERSONATION_STARTED: "Bắt đầu trải nghiệm tài khoản demo",
  DEV_IMPERSONATION_SWITCHED: "Chuyển tài khoản demo",
  DEV_IMPERSONATION_ENDED: "Kết thúc trải nghiệm tài khoản demo",
