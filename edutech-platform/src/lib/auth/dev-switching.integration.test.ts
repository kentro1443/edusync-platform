  ...
  beforeAll(async () => {
    ...
    await db.user.createMany({
      data: [
        {
          id: devUserId,
          email: `dev-${suffix}@test.edutech.local`,
          normalizedEmail: `dev-${suffix}@test.edutech.local`,
        ...
        {
          id: demoUserId,
          email: `demo-${suffix}@test.edutech.local`,
          normalizedEmail: `demo-${suffix}@test.edutech.local`,
        ...
        {
          id: standardUserId,
          email: `standard-${suffix}@test.edutech.local`,
          normalizedEmail: `standard-${suffix}@test.edutech.local`,
