...
const content: ModulePageContent = {
  ...
  heroDescription: "EduTech chuyển các biểu mẫu giấy và chuỗi tin nhắn rời rạc thành quy trình số có điều kiện, người chịu trách nhiệm, thời hạn và lịch sử quyết định rõ ràng.",
