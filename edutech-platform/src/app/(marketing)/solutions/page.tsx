...
export const metadata: Metadata = {
  ...
  description: "Lộ trình triển khai EduTech cho vận hành học sinh, cố vấn, học liệu và quy trình hành chính.",
};
  ...
  return (
    <>
      <section className="border-b bg-[var(--color-surface-warm)] py-20 lg:py-28">
        <Container>
          <p className="text-sm font-bold uppercase tracking-[0.16em] text-[var(--color-brand-700)]">Giải pháp EduTech</p>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[var(--color-ink-500)]">Không ép mọi trường vào cùng một quy trình. EduTech cung cấp nền tảng chung, quyền kiểm soát rõ và lộ trình triển khai theo ưu tiên.</p>
        </Container>
      </section>
